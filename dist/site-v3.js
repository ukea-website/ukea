...
if (pageName === 'index.html') {
  document.querySelector('.recognition')?.insertAdjacentHTML('afterend', `<section class="home-news"><div class="section home-news-inner"><header class="home-news-header"><div class="eyebrow">CẬP NHẬT</div><h2>Tin tức &amp; thông báo</h2><p>Các nội dung đáng chú ý để bạn chuẩn bị cho kỳ thi OTE.</p></header><div class="cms-news-grid" data-cms-news-list data-limit="3" aria-live="polite"></div><div class="home-news-all-wrap"><a class="home-news-all" href="tin-tuc.html"><span>Xem tất cả tin tức</span><span aria-hidden="true">→</span></a></div></div></section>`);
}
